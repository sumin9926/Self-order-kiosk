 ...
 */
public class Kiosk {
    List<Menu> menus=new ArrayList<>(); //Menu 객체를 저장하는 List

    public void addMenu(Menu...menuArr){ //Menu 객체를 List에 저장하는 메서드
    ...
    public <T extends Collection<?>> int scanNumber(T t){ // 카테고리 혹은 음식 메뉴 리스트를 인자로 받음
